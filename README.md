...
The replacement for the file “ensemble_vote.py” is located in the github repository. Copy this into the mlxtend package to replace the old code. Alternatively, 
